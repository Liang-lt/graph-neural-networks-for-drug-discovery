...
```angular2html
python train.py GGNN --train-set data/ESOL_train.csv.gz --valid-set data/ESOL_valid.csv.gz --test-set data/ESOL_test.csv.gz --loss MaskedMultiTaskCrossEntropy --score RMSE --loss MSE --logging less --epochs 1200 --learn-rate 1.176e-5
```
